    ...
    <div className="min-h-screen bg-[#f8fafa]">
      ...
      <section className="pt-28 pb-12 px-6 relative z-10">
        <div className="max-w-6xl mx-auto">
          ...
          >
            <Badge className="mb-4 bg-navy-100 text-navy-700 hover:bg-navy-200 font-dm-sans border-0 px-4 py-1.5">
              Clinical Track
            </Badge>
                    ...
                    <CardContent className="p-6 flex flex-col h-full">
                      <div className="flex items-start justify-between mb-4">
                        {course.content_cards?.length > 0 ? (
                          <div className="flex items-center gap-2" data-testid={`ai-guide-hint-${course.id}`}>
                            <AnimatedAvatar tone="navy" size={32} />
                            <span className="text-[11px] font-dm-sans font-medium text-navy-700">AI Guide</span>
                          </div>
                        ) : (
                      ...
                      <div className="pt-4 border-t border-slate-100 flex items-center justify-between">
                        ...
                        {!course.is_coming_soon && (
                          <Button 
                            size="sm" 
                            className="bg-navy-900 hover:bg-navy-800 font-dm-sans rounded-lg"
